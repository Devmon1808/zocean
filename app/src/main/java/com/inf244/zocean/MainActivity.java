...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        singleRoomButton.setOnClickListener(v ->
                handleReservation("SINGLE")
        );

        doubleRoomButton.setOnClickListener(v ->
                handleReservation("DOUBLE")
        );

        suiteRoomButton.setOnClickListener(v ->
                handleReservation("SUITE")
        );
    }
